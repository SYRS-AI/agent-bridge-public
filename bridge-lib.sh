...
BRIDGE_META_REVIEW_ENABLED="${BRIDGE_META_REVIEW_ENABLED:-1}"
BRIDGE_META_REVIEW_INTERVAL_SECONDS="${BRIDGE_META_REVIEW_INTERVAL_SECONDS:-86400}"
BRIDGE_META_REVIEW_DUE_DAYS="${BRIDGE_META_REVIEW_DUE_DAYS:-7}"
BRIDGE_META_REVIEW_TARGETS="${BRIDGE_META_REVIEW_TARGETS:-SYRS-AI/agent-bridge-public#9}"
BRIDGE_META_REVIEW_MOCK_JSON_FILE="${BRIDGE_META_REVIEW_MOCK_JSON_FILE:-}"
...
export BRIDGE_META_REVIEW_ENABLED BRIDGE_META_REVIEW_INTERVAL_SECONDS BRIDGE_META_REVIEW_DUE_DAYS BRIDGE_META_REVIEW_TARGETS BRIDGE_META_REVIEW_MOCK_JSON_FILE
